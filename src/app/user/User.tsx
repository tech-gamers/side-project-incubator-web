  ...
  render() {
    ...
    return (
      <div className="container mt-5">
        ...
        <h6 className="mt-3">加入我们的 <a href="https://join.slack.com/t/w1594707327-wme701731/shared_invite/zt-fqc09gau-udUOCoJChUZ_L40euEG0Bg">Slack 频道</a></h6>
        <h6>在 <a href="https://github.com/tech-gamers/ideas/issues">这里</a> 参与正价进行中的项目或者发布新想法</h6>
        <h6>扫码加入微信群</h6>
        <img src="/assets/images/wechat-group.jpeg" alt="wechat group QR code" style={{ maxWidth: '300px' }}/>
        <hr />
        <div className="mt-4 text-right">
          <Button danger onClick={this.onSignOut}>Sign out</Button>
        </div>
      </div>
    );
  }
